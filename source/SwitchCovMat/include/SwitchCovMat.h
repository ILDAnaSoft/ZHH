#ifndef SwitchCovMat_h
#define SwitchCovMat_h 1
...
class SwitchCovMat : public Processor
{
	public:

		virtual Processor*  newProcessor()
		{
			return new SwitchCovMat;
		}
		SwitchCovMat();
		virtual ~SwitchCovMat() = default;
		SwitchCovMat(const SwitchCovMat&) = delete;
		SwitchCovMat& operator=(const SwitchCovMat&) = delete;
		virtual void init();
		virtual void Clear();
