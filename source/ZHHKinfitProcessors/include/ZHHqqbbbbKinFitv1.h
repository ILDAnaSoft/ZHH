#ifndef ZHHqqbbbbKinFitv1_h
#define ZHHqqbbbbKinFitv1_h 1
...
class ZHHqqbbbbKinFitv1 : public Processor , public TrueJet_Parser
{
	...
	public:
		...
		{
			return new ZHHqqbbbbKinFitv1;
		}
		ZHHqqbbbbKinFitv1() ;
		virtual ~ZHHqqbbbbKinFitv1() = default;
		ZHHqqbbbbKinFitv1(const ZHHqqbbbbKinFitv1&) = delete;
		ZHHqqbbbbKinFitv1& operator=(const ZHHqqbbbbKinFitv1&) = delete;
