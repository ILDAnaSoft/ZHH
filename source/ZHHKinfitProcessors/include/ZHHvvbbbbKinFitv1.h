#ifndef ZHHvvbbbbKinFitv1_h
#define ZHHvvbbbbKinFitv1_h 1
...
class ZHHvvbbbbKinFitv1 : public Processor , public TrueJet_Parser
{
	...
	public:
		...
		{
			return new ZHHvvbbbbKinFitv1;
		}
		ZHHvvbbbbKinFitv1() ;
		virtual ~ZHHvvbbbbKinFitv1() = default;
		ZHHvvbbbbKinFitv1(const ZHHvvbbbbKinFitv1&) = delete;
		ZHHvvbbbbKinFitv1& operator=(const ZHHvvbbbbKinFitv1&) = delete;
		...
		std::vector<double> calculateInitialMasses(pfoVector jets, pfoVector leptons, vector<unsigned int> perm, bool woNu);
