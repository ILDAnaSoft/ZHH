#ifndef ZHHllbbbbKinFitv1_h
#define ZHHllbbbbKinFitv1_h 1
...
class ZHHllbbbbKinFitv1 : public Processor , public TrueJet_Parser
{
	...
	public:
		...
		{
			return new ZHHllbbbbKinFitv1;
		}
		ZHHllbbbbKinFitv1() ;
		virtual ~ZHHllbbbbKinFitv1() = default;
		ZHHllbbbbKinFitv1(const ZHHllbbbbKinFitv1&) = delete;
		ZHHllbbbbKinFitv1& operator=(const ZHHllbbbbKinFitv1&) = delete;
