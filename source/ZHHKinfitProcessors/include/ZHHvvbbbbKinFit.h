...
class ZHHvvbbbbKinFit : public Processor, public ZHHBaseKinfitProcessor
{
	...
	public:
		...
		virtual void	check( LCEvent * evRt );

		TTree *m_pTTree = new TTree("ZHHvvbbbbKinFit", "ZHHvvbbbbKinFit");
