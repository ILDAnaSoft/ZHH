...
ZHHKinFit::FitResult ZHHKinFit::performqqbbbbFIT( pfoVector jets, bool traceEvent, LCCollection *originalJetCollection) {
  ...
  if (m_fithypothesis == "ZZH" || m_fithypothesis == "ZZHsoft" || m_fithypothesis == "MH" || m_fithypothesis == "ZHH" || m_fithypothesis == "ZHHsoft" || m_fithypothesis == "EQM") {
    ...
    perms = {
      {0, 1, 2, 3, 4, 5}, 2{1, 2, 0, 3, 4, 5}, same1{0, 2, 1, 3, 4, 5}, same1{1, 3, 0, 2, 4, 5}, 2{0, 3, 1, 2, 4, 5}, {2, 3, 0, 1, 4, 5}
      {2, 4, 0, 1, 3, 5}, {0, 1, 2, 4, 3, 5}, {1, 2, 0, 4, 3, 5}, {0, 2, 1, 4, 3, 5}, {1, 4, 0, 2, 3, 5}, {0, 4, 1, 2, 3, 5}
      {1, 3, 0, 4, 2, 5}, {3, 4, 0, 1, 2, 5}, {0, 3, 1, 4, 2, 5}, {1, 4, 0, 3, 2, 5}, {0, 4, 1, 3, 2, 5}
      {3, 4, 0, 2, 1, 5}, {2, 4, 0, 3, 1, 5}, {2, 3, 0, 4, 1, 5}
      {0, 5, 1, 2, 3, 4}, {0, 1, 2, 5, 3, 4}, {1, 2, 0, 5, 3, 4}, {2, 5, 0, 1, 3, 4}, {0, 2, 1, 5, 3, 4}, {1, 5, 0, 2, 3, 4}
      {1, 3, 0, 5, 2, 4}, {0, 3, 1, 5, 2, 4}, {1, 5, 0, 3, 2, 4}, {3, 5, 0, 1, 2, 4}, {0, 5, 1, 3, 2, 4}
      {2, 5, 0, 3, 1, 4}, {3, 5, 0, 2, 1, 4}, {2, 3, 0, 5, 1, 4}
      {1, 4, 0, 5, 2, 3}, {0, 4, 1, 5, 2, 3}, {1, 5, 0, 4, 2, 3}, {4, 5, 0, 1, 2, 3}, {0, 5, 1, 4, 2, 3}
      {2, 5, 0, 4, 1, 3}, {4, 5, 0, 2, 1, 3}, {2, 4, 0, 5, 1, 3}
      {3, 4, 0, 5, 1, 2}, {3, 5, 0, 4, 1, 2}, {4, 5, 0, 3, 1, 2}
