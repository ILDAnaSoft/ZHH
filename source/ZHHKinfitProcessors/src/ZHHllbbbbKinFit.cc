...
ZHHllbbbbKinFit::ZHHllbbbbKinFit(): ZHHBaseKinfitProcessor("ZHHllbbbbKinFit") {
...
void ZHHllbbbbKinFit::initChannelValues()
{
...
void ZHHllbbbbKinFit::clearChannelValues() {
  // must be changed when properties are added which do not appear in base;
}

void ZHHllbbbbKinFit::updateChannelValues( EVENT::LCEvent *pLCEvent )
{  
