...
class ffhh: public p6 {
    ...
    public:
        ...
        vector<int> resolve(LCCollection *mcp_collection) {
            ...
            m_n_b_from_higgs = count(d1.begin(), d1.end(), 5) + count(d2.begin(), d2.end(), 5) + count(d1.begin(), d1.end(), -5) + count(d2.begin(), d2.end(), -5);        
            m_n_c_from_higgs = count(d1.begin(), d1.end(), 4) + count(d2.begin(), d2.end(), 4) + count(d1.begin(), d1.end(), -4) + count(d2.begin(), d2.end(), -4);
