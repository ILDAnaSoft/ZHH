#ifndef ZHHll4JLeptonSelectionMVAProcessor_h
#define ZHHll4JLeptonSelectionMVAProcessor_h 1
 ...
 * 
 * @author F. Gaede, DESY
 * @version $Id: ZHHll4JLeptonSelectionMVAProcessor.h,v 1.4 2005-10-11 12:57:39 gaede Exp $ 
 */

class ZHHll4JLeptonSelectionMVAProcessor : public Processor {
  
 public:
  
  virtual Processor*  newProcessor() { return new ZHHll4JLeptonSelectionMVAProcessor ; }
  
  
  ZHHll4JLeptonSelectionMVAProcessor() ;
