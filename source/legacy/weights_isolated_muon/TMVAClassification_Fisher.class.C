...
Creator        : tianjp
Date           : Tue Jan  1 06:39:56 2013
Host           : Linux cw103.cc.kek.jp 2.6.18-164.el5 #1 SMP Tue Aug 18 15:51:48 EDT 2009 x86_64 x86_64 x86_64 GNU/Linux
Dir            : /gpfs/fs01/ilc/tianjp/analysis/DBD/vvhh/run/lepOpt/macros_yyxyev_vvhh
Training events: 8906
...
NVar 2
coneec                        coneec                        coneec                        coneec                                                          'c'    [0,313.059539795]
momentum                      momentum                      momentum                      momentum                                                        'm'    [5.00014305115,360.464019775]
NSpec 0
...
class ReadFisher : public IClassifierReader {
 ...
 public:
   ...
   {      
      ...
      const char* inputVars[] = { "coneec", "momentum" };
      ...
      fVmin[0] = 0;
      fVmax[0] = 313.059539794922;
      fVmin[1] = 5.00014305114746;
      fVmax[1] = 360.464019775391;
...
{
   fFisher0 = -0.033804120131;
   fFisherCoefficients.push_back( -0.00654514043066 );
   fFisherCoefficients.push_back( 0.00499560929754 );
