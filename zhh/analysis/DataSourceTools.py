...
def apply_split(*fracs, source:DataSource, name:str='split', seed:int=42)->np.ndarray:
...
def mod_weights_from_split(source:DataSource, split_prop:str='split', weight_prop:str='weight'):
