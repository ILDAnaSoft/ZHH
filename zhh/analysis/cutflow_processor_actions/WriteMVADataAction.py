...
class WriteMVADataAction(FileBasedProcessorAction):
    def __init__(self, cp: CutflowProcessor, steer: dict, mva:str, weight_column='weights_split',
                 step:int=0, train_split:int=0, test_split:int=1, val_split:int|None=None, **kwargs):
        ...
        Args:
            ...
            weight_column (str, optional): _description_. Defaults to 'weights_split'.
