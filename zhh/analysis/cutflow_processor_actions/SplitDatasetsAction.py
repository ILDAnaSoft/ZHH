...
class SplitDatasetsAction(CutflowProcessorAction):
    def __init__(self, cp:CutflowProcessor, steer:dict, fractions:list[float],
                 source_weight_column:str='weight', split_column:str='split', wt_split_column:str='weights_split', **kwargs):
        ...
        Args:
            ...
            source_weight_column (str, optional): column of event weights to scale. Defaults to 'weight'.  
        ...
        self._source_weight_column = source_weight_column
